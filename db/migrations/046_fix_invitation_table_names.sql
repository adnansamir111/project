-- Fix table name from organization_members to org_members
-- Migration: 046_fix_invitation_table_names.sql
...
BEGIN
    ...
    INSERT INTO org_members (organization_id, user_id, role_id)
